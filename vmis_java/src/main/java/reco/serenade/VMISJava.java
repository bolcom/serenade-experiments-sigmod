...
import reco.serenade.models.VMISkNN;
...
public class VMISJava {

    public static void main(String[] args) throws IOException {
        if (args.length != 4) {
            System.err.println("Invalid arguments. Usage: " + VMISJava.class.getSimpleName() + " ../datasets/retailrocket9_train.txt ../datasets/retailrocket9_test.txt java_vsknn_predictions.txt java_position_latency.csv");
            System.exit(-1);
        }
        ...
        VMISkNN model = new VMISkNN(100, 5000);
