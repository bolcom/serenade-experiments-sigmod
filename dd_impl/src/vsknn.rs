...
mod tests {
    ...
    fn test_toy_example() {
        ...
        let vsknn = VSKnn::new(k, m, historical_sessions);
        ...
        let neighbors = find_neighbors(
            ...
            m,
            &evolving_session,
            &vsknn.historical_item_index,
            &vsknn.historical_session_max_order,
            &vsknn.historical_session_index
        );
        ...
        let recos = vsknn.predict(&evolving_session);
        ...
        let recos = vsknn.predict(&evolving_session_two);
