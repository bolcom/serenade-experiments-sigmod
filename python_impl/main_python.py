...
from models.vsknn.vsknn import VMContextKNN
...
def run(training_csv_path, test_csv_path, outputfilename, latency_outputfilename):
    ...
    model = VMContextKNN(k=100, sample_size=5000, weighting='div', weighting_score='linear', idf_weighting=1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('training_csv_path', help='Path to training data. Like ../datasets/private-clicks-1m_train.txt')
    parser.add_argument('test_csv_path', help='Path to test data. Like ../datasets/private-clicks-1m_test.txt')
    parser.add_argument('outputfilename', help='Output filename where the predictions will be writen to. Like vsknn_py_predictions.txt')
    parser.add_argument('latency_outputfilename', help='Output latency_outputfilename where the predictions will be writen to. Like vsknn_py_latencies.txt')
