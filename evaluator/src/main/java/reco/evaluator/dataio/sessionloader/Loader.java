package reco.evaluator.dataio.sessionloader;
...
public class Loader {
    ...
    public static List<Row> readCsv(String fullPathToCsvFile) throws IOException {
        ...
        BufferedReader br = Loader.createReaderFor(fullPathToCsvFile);
    ...
    public static BufferedReader createReaderFor(String fullPathToCsvFile) throws FileNotFoundException {
